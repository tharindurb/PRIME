...
public class NLPToolsControllerOpenNLP {
	...
	private NLPToolsControllerOpenNLP() throws IOException {
        POSModel posModel = new POSModel(new FileInputStream("./Resources/JATEResources/en-pos-maxent.bin"));
		_posTagger = new POSTaggerME(posModel);

        ChunkerModel chunkerModel = new ChunkerModel(new FileInputStream("./Resources/JATEResources/en-chunker.bin"));
		_npChunker = new ChunkerME(chunkerModel);

        TokenizerModel tokenizerModel = new TokenizerModel(new FileInputStream("./Resources/JATEResources/en-token.bin"));
		_tokenizer = new TokenizerME(tokenizerModel);

        SentenceModel sentModel = new SentenceModel(new FileInputStream("./Resources/JATEResources/en-sent.bin"));
